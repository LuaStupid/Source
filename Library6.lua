if (game:GetService("CoreGui")):FindFirstChild("Hiru Hub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Hiru Hub:Destroy();
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("Hiru Hub")).Enabled = not (game.CoreGui:FindFirstChild("Hiru Hub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("Hiru Hub/Library/") then
			makefolder("Hiru Hub/Library/");
		end;
		if not isfile(("Hiru Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Hiru Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Hiru Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Hiru Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Hiru Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local Hiru Hub = Instance.new("ScreenGui");
	Hiru Hub.Name = "Hiru Hub";
	Hiru Hub.Parent = game.CoreGui;
	Hiru Hub.DisplayOrder = 999;
