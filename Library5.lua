if (game:GetService("CoreGui")):FindFirstChild("HiruHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).HiruHub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
getgenv().Primary = Color3.fromRGB(100, 100, 100);
getgenv().Dark = Color3.fromRGB(22, 22, 26);
getgenv().Third = Color3.fromRGB(255, 0, 0);
...
OutlineButton.BackgroundColor3 = getgenv().Dark;
...
ImageButton.BackgroundColor3 = getgenv().Dark;
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("HiruHub")).Enabled = not (game.CoreGui:FindFirstChild("HiruHub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Frame.BackgroundColor3 = getgenv().Dark;
	...
	Title.Parent = Frame;
	Title.BackgroundColor3 = getgenv().Primary;
	...
	Desc.Parent = Frame;
	Desc.BackgroundColor3 = getgenv().Primary;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("HiruHub") then
			makefolder("HiruHub");
		end;
		if not isfolder("HiruHub/Library/") then
			makefolder("HiruHub/Library/");
		end;
		if not isfile(("HiruHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("HiruHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("HiruHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("HiruHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("HiruHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local HiruHub = Instance.new("ScreenGui");
	HiruHub.Name = "Hiru Hub";
	HiruHub.Parent = game.CoreGui;
	HiruHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = Hiru Hub;
	...
	DragButton.BackgroundColor3 = getgenv().Primary;
	...
	CloseButton.BackgroundColor3 = getgenv().Primary;
	...
	ResizeButton.BackgroundColor3 = getgenv().Primary;
	...
	CloseSettings.BackgroundColor3 = getgenv().Primary;
	...
	SettingsButton.BackgroundColor3 = getgenv().Primary;
	...
	Page.Name = "Page";
	Page.Parent = Main;
	Page.BackgroundColor3 = getgenv().Dark;
	...
	function uitab:Tab(text, img)
		...
		SelectedTab.BackgroundColor3 = getgenv().Third;
		...
		MainFramePage.BackgroundColor3 = getgenv().Dark;
		...
		function main:Button(text, callback)
			...
			Button.BackgroundColor3 = getgenv().Primary;
			...
			ImageLabel.BackgroundColor3 = getgenv().Primary;
			...
			TextLabel.BackgroundColor3 = getgenv().Primary;
			...
			ArrowRight.BackgroundColor3 = getgenv().Primary;
		...
		function main:Toggle(text, config, desc, callback)
			...
			ToggleFrame.BackgroundColor3 = getgenv().Dark;
			...
			ToggleImage.MouseButton1Click:Connect(function()
				if toggled == false then
					...
					(TweenService:Create(ToggleImage, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						BackgroundColor3 = getgenv().Third,
		...
		function main:Dropdown(text, option, var, callback)
			...
			Dropdown.BackgroundColor3 = getgenv().Primary;
			...
			DropTitle.BackgroundColor3 = getgenv().Primary;
			...
			ArrowDown.BackgroundColor3 = getgenv().Primary;
			...
			for i, v in next, option do
				...
				Item.BackgroundColor3 = getgenv().Primary;
				...
				SelectedItems.BackgroundColor3 = getgenv().Third;
		...
		function main:Slider(text, min, max, set, callback)
			...
			Slider.BackgroundColor3 = getgenv().Primary;
			...
			sliderr.BackgroundColor3 = getgenv().Primary;
			...
			bar1.Name = "bar1";
			bar1.Parent = bar;
			bar1.BackgroundColor3 = getgenv().Third;
		...
		function main:Textbox(text, disappear, callback)
			...
			Textbox.BackgroundColor3 = getgenv().Primary;
			...
			TextboxLabel.BackgroundColor3 = getgenv().Primary;
		...
		function main:Label(text)
			...
			Frame.BackgroundColor3 = getgenv().Primary;
		...
		function main:Seperator(text)
			...
			Seperator.BackgroundColor3 = getgenv().Primary;
		...
		function main:Line()
			...
			UIGradient.Color = ColorSequence.new({
				ColorSequenceKeypoint.new(0, getgenv().Dark),
				ColorSequenceKeypoint.new(0.4, getgenv().Primary),
				ColorSequenceKeypoint.new(0.5, getgenv().Primary),
				ColorSequenceKeypoint.new(0.6, getgenv().Primary),
				ColorSequenceKeypoint.new(1, getgenv().Dark)
			});
